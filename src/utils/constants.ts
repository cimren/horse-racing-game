export const horseData = [
  ...
  { id: 14, name: 'Phantom', condition: 56, color: 'teal' },
  { id: 15, name: 'Blizzard', condition: 57, color: 'cyan' },
  { id: 16, name: 'Inferno', condition: 58, color: 'crimson' },
  { id: 17, name: 'Tempest', condition: 59, color: 'lavender' },
  { id: 18, name: 'Abyss', condition: 60, color: 'indigo' },
  { id: 19, name: 'Radiant', condition: 61, color: 'magenta' },
